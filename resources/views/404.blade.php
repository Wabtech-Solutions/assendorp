...
@section('content')
    ...
    <head>
        ...
        <title>404 - Rijschool Assendorp</title>
    ...
    <body>
        ...
        <div class="content-wrapper">
            ...
            <h2>Oeps! Deze pagina konden we niet vinden <i class="fa-regular fa-face-frown-open"></i></h2>
            <p>De pagina bestaat helaas niet meer of is tijdelijk niet bereikbaar.</p>
            <a href="/" class="btn style2">Terug naar de homepage</a>
            </div>
            </div>
            </div>
            </div>
